...
public class GUIcontentTV extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUIcontentTV frame = new GUIcontentTV();
	...
	public GUIcontentTV() {
		...
		scrollPane.setBounds(77, 35, 612, 160);
		contentPane.add(scrollPane);
		
		table = new JTable(new TblContentModelTV());
		...
		label_1.setBounds(50, 267, 63, 14);
		...
		label_2.setBounds(50, 296, 53, 14);
		...
		spinner.setBounds(407, 294, 69, 20);
		contentPane.add(spinner);
		spinner_1.setModel(new SpinnerNumberModel(0.0, 0.0, 10.0, 1.0));
		
		
		spinner_1.setBounds(407, 238, 59, 20);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ContentServicesDelegate.deleteContent(c);
				 ...
				 dispose();
				  new GUIcontentTV().setVisible(true);
		...
		JLabel lblManageTvsHows = new JLabel("MANAGE TVS SHOWS");
		lblManageTvsHows.setForeground(Color.RED);
		lblManageTvsHows.setFont(new Font("Yu Gothic Medium", Font.BOLD, 17));
		lblManageTvsHows.setBounds(77, 200, 237, 29);
		contentPane.add(lblManageTvsHows);
		
		JLabel lblNewLabel = new JLabel("New label");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Marwen\\Desktop\\33950411-Music-and-entertainment-collage-with-icons-background-Vector-illustration-Stock-Vector.jpg"));
