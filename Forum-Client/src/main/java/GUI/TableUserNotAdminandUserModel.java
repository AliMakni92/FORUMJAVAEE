...
class TableUserNotAdminandUserModel extends AbstractTableModel {
	...
	private String x="moderator";
List< User> userss=AccountManagementServiceDelegate.findAllUserNotAdminAndUser(x);
